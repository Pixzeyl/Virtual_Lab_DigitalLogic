...
<body class="style-0">
 ...
 <figure class="style-17"><a href="interface.php"><img color="default" width="150" class="style-18" alt="Navbar logo" sizes="[object Object]" src="../../images/background/kjsieit-logo.svg" /></a></figure>
 <div class="style-19">
 ...
 <div class="style-21">
 <nav class="style-22">
<div class="style-24"><a class="style-28" href="../app/request/req.php">Admin Requests</a></div>
 <div class="style-26"> 
 <div class="style-27"><a class="style-28" href="../app/feedanalysis/analysis.php">Feedback Analysis</a></div>
 </div>
 <div class="style-26">
 <div class="style-27"><a class="style-28" href="../app/logicquestion/logicq.php">Logic Questions</a></div>
 </div>
 <div class="style-26">
 <div class="style-27"><a class="style-28" href="../app/feedpage/feed.php">Feedback</a></div>
 </div>
 <div class="style-35">
 <div class="style-36"><a class="style-37" href="../../interface/logout/logout.php">Logout</a></div>
 </div>

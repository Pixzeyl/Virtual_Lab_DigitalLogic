...
<head>
 ...
 body {
            ...
            margin: 0;
            padding: 0;
            background: url("../../../../images/background/red2.jpg")  no-repeat center center fixed;
...
<a href="../List.php" class="back-button">Back</a>
    ...
    <div class="tab1">
        ...
        <div id = "result"></div>
        <div class="mn"style="margin:auto"><div class = "hin"><img src="../../../../images/flowchart/Flow-chart-of-Restoring-Division-Algorithm.png" height="50%"></div>
    </div>
    </div>
    
    <div> <script src='../../../../formula/Aryan.js'></script>
        <script>
        ...
        button.addEventListener('click', async () => {
                ...
                if (flag) {
                    list = random();
                  result =  restoring(list[1],list[0]);

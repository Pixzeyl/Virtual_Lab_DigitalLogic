...
<header>
        ...
        <h2 style="text-align:center;">Restoring Division Algorithm</h2>
    ...
    <form action="../../../../databaseinfo/feedback/feedback.php" method="post" id="feedbackForm" onsubmit="return validate();">
        <label for="name">Username:<p id= "username" name="name"> <?php echo $_SESSION['user']?></p></label>
        <label for="email">Email:<p id = "email" name="email"><?php echo $_SESSION['email'] ?></p></label>

...
<header class="Nav">
    ...
    <main><br><br><br>
        <div class="quiz-container">
            ...
            <h2>Encoder & Decoder Quiz</h2>
            <div class="quiz">
            <ol>
                <div class="tab"></div>
            </ol>
            <button class="submit-button" onclick="submitMUX(count)">Check Answer</button>
            <p class="score"></p>
            <a href="encodefeed.php"><button class="feed-button">Submit Feedback</button></a>
        </div>
    </main>
